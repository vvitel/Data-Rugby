...
# Annoter le match
@callback([Output("store_annot", "data"), Output("alert_annot_add", "hide"), 
           Output("alert_suppr_add", "hide"), Output("alert_send_data", "hide")],
          [Input("btn_debmt1", "n_clicks"), Input("btn_debmt2", "n_clicks"), Input("btn_finmt1", "n_clicks"),
           Input("btn_finmt2", "n_clicks"), Input("btn_touche", "n_clicks"), Input("btn_melee", "n_clicks"),
           Input("btn_renvoi", "n_clicks"), Input("btn_essai", "n_clicks"), Input("btn_highlight", "n_clicks"),
           Input("btn_suppr", "n_clicks"), Input("btn_senddata", "n_clicks")],
          [State("input_namegame", "value"), State("store_annot", "data")])
def annotate_game(btn_debmt1, btn_debmt2, btn_finmt1, btn_finmt2, btn_touche,
                  btn_melee, btn_renvoi, btn_essai, btn_highlight, 
                  btn_suppr, btn_senddata, input_namegame, store_annot):
    ...
    events = {"btn_debmt1": "debmt1", "btn_debmt2": "debmt2", "btn_finmt1": "finmt1",
              "btn_finmt2": "finmt2", "btn_touche": "touche", "btn_melee": "melee",
              "btn_renvoi": "renvoi", "btn_essai": "essai", "btn_highlight": "highlight"}
    ...
    # Enregistrer dans la base de données
        ...
        document_annot = {"date": time.strftime("%Y-%m-%d", time.localtime()).replace("-", "/"),
                          "game": input_namegame,
                          "annotations": data_annot}
        collection_annotation.insert_one(document_annot)
